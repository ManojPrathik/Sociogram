...
const CreatePost = ()=>{
    ...
    const postDetails=()=>{
        ...
        data.append("cloud_name","sociogram")
        fetch("https://api.cloudinary.com/v1_1/sociogram/image/upload",{
            method:"post",
            body:data
        }).then(res=>res.json())
        .then(data=>{
    ...
    return(
        ...
        >
            ...
            <button className="btn waves-effect waves-light  #6a1b9a purple darken-3" onClick={()=>postDetails()} >Post
            </button>
